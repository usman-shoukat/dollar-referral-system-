<x-homelink/>
    ...
    <body class="main-body dark-theme">
            ...
            <div class="main-signin-wrapper">
                ...
                <div class="sign-up-body wd-md-50p">
                    <div class="main-signin-header">
                        ...
                        <form method="POST" action="{{ route('heaven.store',['ref'=> $re]) }}">
                          @csrf
        ...
        <!--- JQuery min js --->
        <script src="{{asset('home/assets/plugins/jquery/jquery.min.js')}}"></script>

        <!--- Bootstrap Bundle js --->
        <script src="{{asset('home/assets/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

        <!--- Ionicons js --->
        <script src="{{asset('home/assets/plugins/ionicons/ionicons.js')}}"></script>

        <!--- Moment js --->
        <script src="{{asset('home/assets/plugins/moment/moment.js')}}"></script>

        <!--- Eva-icons js --->
        <script src="h{{asset('home/assets/js/eva-icons.min.js')}}"></script>

        <!--- Rating js --->
        <script src="{{asset('home/assets/plugins/rating/jquery.rating-stars.js')}}"></script>
        <script src="{{asset('home/assets/plugins/rating/jquery.barrating.js')}}"></script>

        <!--- JQuery sparkline js --->
        <script src="{{asset('home/assets/plugins/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
